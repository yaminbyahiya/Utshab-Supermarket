...
class Food_Grocery_Store_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <div class="social-icon-search">
                    <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'food-grocery-store' ); ?>">
                </div>
                ...
                <ul class="icon-list clearfix">
                    <?php
                    $food_grocery_store_font_awesome_icon_array = food_grocery_store_font_awesome_icon_array();
                    foreach ($food_grocery_store_font_awesome_icon_array as $food_grocery_store_font_awesome_icon) {
                            $icon_class = $this->value() == $food_grocery_store_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($food_grocery_store_font_awesome_icon).'"></i>
                            <span class="food-grocery-store-social-class">'.esc_attr($food_grocery_store_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function food_grocery_store_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'food-grocery-store-customizer-script', esc_url(get_template_directory_uri()).'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'food_grocery_store_customizer_script' );

if(!function_exists('food_grocery_store_font_awesome_icon_array')){
    function food_grocery_store_font_awesome_icon_array(){
